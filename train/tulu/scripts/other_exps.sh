...
#### LLAMA 8B CLASSSICO #########
###########################################
 # LORA RUN 8B Lora rank=16
sbatch --gres=gpu:1 -J llama_3_8B_lora_r64 ./launch_tulu_sft.sh config_lora \
 --model_name_or_path=meta-llama/Meta-Llama-3-8B-Instruct \
 --tokenizer_name=meta-llama/Meta-Llama-3-8B-Instruct \
 --output_dir=output/llama_3_8B_lora_r16 \
 --lora_rank=16 \
 --lora_alpha=32
#job 34246

 # LORA RUN 8B Lora QK rank 128
sbatch --gres=gpu:1 -J llama_3_8b_lora_qk_r128 ./launch_tulu_sft.sh config_lora \
 --model_name_or_path=meta-llama/Meta-Llama-3-8B-Instruct \
 --tokenizer_name=meta-llama/Meta-Llama-3-8B-Instruct \
 --output_dir=output/llama_3_8b_loraqk_r128 \
 --lora_rank=128 \
 --lora_alpha=256 \
 --lora_modules="['q_proj','k_proj']"
#job 34320 --DONE

# DiffLora RUN 8B, both sides, rank 64
sbatch --gres=gpu:1  -J llama_3_8B_difflora_r64 ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Meta-Llama-3-8B-Instruct \
--output_dir=output/llama_3_8B_difflora_r64_bothterms \
--diff_transformer_base_model_name=meta-llama/Meta-Llama-3-8B-Instruct \
--output_dir=output/llama_3_8b_difflora_r64  \
...
--use_lora=false
#job 34319 - right only --stopped
# 34430 - both sides -- DONE

# DiffLora RUN 8B, both sides, rank 64, default init
sbatch --gres=gpu:1  -J llama_3_8B_difflora_r64 ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Meta-Llama-3-8B-Instruct \
--output_dir=output/llama_3_8B_difflora_r64_bothterms \
--diff_transformer_base_model_name=meta-llama/Meta-Llama-3-8B-Instruct \
...
# DiffLora RUN 8B, both sides, rank 64, default init, with groupnorm
sbatch --gres=gpu:1  -J llama_3_8B_difflora_r64 ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Meta-Llama-3-8B-Instruct \
--output_dir=output/llama_3_8B_difflora_r64_groupnorm_real_definit_lambda \
--diff_transformer_base_model_name=meta-llama/Meta-Llama-3-8B-Instruct \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
...
--gradient_checkpointing=true \
--use_lora=false
# 36428 (with lambda init with 0)  36555 (with real defining)

###########################################
#### LLAMA 1B CLASSSICO #########
###########################################
# LORA RUN 1B full Lora rank=8 to make compatible with existing models
sbatch --gres=gpu:1 -J llama_32_1B_lora_r8 ./launch_tulu_sft.sh config_lora \
 --model_name_or_path=meta-llama/Llama-3.2-1B-Instruct \
  --tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
  --output_dir=output/llama_32_1B_lora_r8 \
  --per_device_train_batch_size=2 \
  --gradient_accumulation_steps=32 \
  --lora_rank=8 \
  --lora_alpha=16 
...
# LORA RUN 1B full Lora rank=8 to make compatible with existing models
sbatch --gres=gpu:1 -J llama_32_1B_lora_r8_lr5e5 ./launch_tulu_sft.sh config_lora \
 --model_name_or_path=meta-llama/Llama-3.2-1B-Instruct \
  --tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
  --output_dir=output/llama_32_1B_lora_r8_lr5e5 \
  --per_device_train_batch_size=2 \
  --gradient_accumulation_steps=32 \
  --lora_rank=8 \
  --lora_alpha=16 \
...
# LORA RUN 1B Lora rank=64, Lora on Q and K only AS SHOULD BE
sbatch --gres=gpu:1 -J llama_32_1B_lora_r64_qk_lr5e5 ./launch_tulu_sft.sh config_lora \
 --model_name_or_path=meta-llama/Llama-3.2-1B-Instruct \
  --tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
  --output_dir=output/llama_32_1B_lora_r64_qk_lr5e5 \
  --per_device_train_batch_size=2 \
  --gradient_accumulation_steps=32 \
  --lora_rank=64 \
  --lora_alpha=128 \
...
# LAMBDA = 0.1, r=32
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_withinit01_r32 \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_withinit01_r32_eager \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_withdefinit_groupnorm_withlinit_r32 \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_withdefinit_withlinit_r32 \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_sum \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_real_definit_r32_groupnorm \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
#36499
 ...
 # both sides, learn lambda, r32, with groupnorm, default init
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_groupnorm \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
# both sides, learn lambda, r32, with groupnorm, default init, with sum loss
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_groupnorm_sum \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
# right only , r64, learn_lambda
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r64_right_only  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
# right only , r64, learn_lambda, withgroupnorm
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r64_right_only_groupnorm  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r64_right_only_groupnorm_sum  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_real_definit_r64_right_only_groupnorm  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
# right only , r64, learn_lambda, init 0.1 
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_init01_r64_right_only  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
# right only , r64, learn_lambda, default init
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r64_right_only_withlinit  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_withfixedtok \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
#with tulu3, both sides, learn lambda, groupnorm
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora_tulu3 \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_tulu3_groupnorm \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_definit_r32_tulu3_withlinit \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_init0_r32_tulu3_nogroupnorm \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=64 \
...
#tulu3, right side only
sbatch --gres=gpu:1  ./launch_tulu_sft.sh config_lora_tulu3 \
--tokenizer_name=meta-llama/Llama-3.2-1B-Instruct \
--diff_transformer_base_model_name=meta-llama/Llama-3.2-1B-Instruct \
--output_dir=output/llama_32_1B_learnlambda_r64_tulu3_nogroupnorm_right_side_sum  \
--per_device_train_batch_size=2 \
--gradient_accumulation_steps=32 \
--diff_transformer=true \
--lora_alpha=128 \
--lora_rank=64 \
--lora_negative_term_only=true \
--groupnorm=false \
--gradient_checkpointing=true \
--use_lora=false \
--reduce_loss=sum
